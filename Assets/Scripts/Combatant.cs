...
namespace LIMB {
    ...
    public class Combatant {
        ...
        public Combatant(CombatantData combatantData){
            ...
            this.currentHealth = combatantData.GetStat(Stats.DERIVED_STAT.HP);
        }
        ...
        public float GetTotalResistance(Damage.TYPE type, string limbName) {
            Stats.DERIVED_STAT stat = Stats.GetResistance(type);
        ...
        /// </summary>
        /// <returns></returns>
        public float GetTotalStat(Stats.DERIVED_STAT stat, string limbName) {
        ...
        public float GetRawStat(Stats.DERIVED_STAT stat, string limbName = null) {
